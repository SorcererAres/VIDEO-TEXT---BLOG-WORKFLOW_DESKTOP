...
- **风格指纹比对**（Step 7）：`Context/HISTORY.md` 近 10 条
- **视角铁律**：博文一律以「演讲人本人」为「我」，HISTORY **不得**作为论据来源（详见 `Context/PREFERENCES.md`「人称与语气」与本表第二点之二「演讲人主体」）
...
3. （可选）在 `视频博文工作流-架构版.md §4.3` 补一句差异化描述
